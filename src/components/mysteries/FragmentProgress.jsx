  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-medium">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div
          className={`px-4 py-2 rounded-full ${productionStatusConfig.color} flex items-center gap-2 shadow-sm`}
        >
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <div className="text-sm text-gray-700">Fragment Manifestation</div>
        ...
        <div className="flex justify-between text-sm">
          ...
          <div
            className={`font-medium ${
              thresholdReached ? "text-green-600" : "text-accent-600"
            }`}
          >
      ...
      <div className="mb-8">
        <div className="text-sm text-gray-700 mb-4">Fragment Assembly</div>
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-soft">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">Keeper Guardians</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-soft">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">Needed for Forge</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-soft">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">Total Fragments</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="pt-6 border-t border-gray-200">
        <div className="text-sm text-gray-700 mb-3">Current Phase</div>
      ...
      {!thresholdReached && productionStatus === "awaiting" && (
        <div className="mt-6 p-4 bg-gradient-to-r from-accent-50 to-yellow-50 border border-accent-200 rounded-xl">
          <div className="flex items-center gap-3">
