  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (
        ...
        setUnverifiedUserId(err.response?.data?.userId);
  ...
  return (
    <>
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="p-4 bg-white/50 backdrop-blur-sm rounded-xl">
              ...
              <p className="text-sm font-medium mt-2">Exclusive Mysteries</p>
              <p className="text-xs text-gray-600">Unique puzzles await</p>
            </div>
            <div className="p-4 bg-white/50 backdrop-blur-sm rounded-xl">
              <div className="text-2xl">💎</div>
              <p className="text-sm font-medium mt-2">Rare Fragments</p>
              <p className="text-xs text-gray-600">Collect limited pieces</p>
            </div>
            <div className="p-4 bg-white/50 backdrop-blur-sm rounded-xl">
              <div className="text-2xl">🏆</div>
              <p className="text-sm font-medium mt-2">Solve & Win</p>
              <p className="text-xs text-gray-600">Amazing prizes</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <EmailVerificationModal
        ...
        // Don't pass userId - user is not logged in
        onVerified={() => {
