...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    setIsLoading(true);
    try {
      const response = await registering(data);
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-primary-50 to-pink-50 rounded-2xl p-8">
                ...
                {/* Stats */}
                <div className="mt-8 pt-8 border-t border-primary-100 grid grid-cols-2 gap-4">
